export const servicePages = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      summary: "The manager of a three-storey residential building contacted Vallano Roofing after a resident reported water running down a chimney breast, blistering the paintwork and staining the ceiling. The project location and client are not identified, but the reported symptoms, inspection findings and completed repair are documented here.",
