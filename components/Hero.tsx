  ...
  return <section className="hero" id="repairs" aria-labelledby="hero-heading">
    <div className="shell hero-grid">
      ...
      <div className="hero-media">
        <div className="hero-image"><Image src="/work/roof-repairs-christleton-rowton-waverton-vallano-roofing.jpeg" alt="Completed lead abutment flashing repair on a tiled roof by Vallano Roofing" width={1200} height={1600} priority sizes="(max-width: 800px) 100vw, 43vw" /></div>
